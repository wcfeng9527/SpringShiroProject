        ...
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header">
                    <a class="navbar-brand" href="#"><span style="font-weight:bolder;">世界玖玖--白名单自动化管理系统</span>
                    </a>
                </div>
        ...
        <ul id="main-nav" class="nav nav-tabs nav-stacked" style="">
            ...
            <li class="active">
                ...
                <div class="collapse" id="collapseExample">
                    <ul class="nav nav-list collapse secondmenu">
                        <li><a href="${ctx }/channel/queryChannelConfiguration" target="main">渠道配置管理</a></li>
                    </ul>
                    <ul class="nav nav-list collapse secondmenu">
                        <li><a href="${ctx }/ipccprioritylist" target="main">查看航线航司资源优先级</a></li>
                        
                    </ul>
                    <ul class="nav nav-list collapse secondmenu">
                        <li><a href="${ctx }/onequalityloglist" target="main">查看日志</a></li>
